...
const ProductDetail = () => {
  ...
  // ("ProductDetailRating", Array.isArray(product));
  ...
  return (
    <>
      <div className="lg:flex lg:items-start lg:justify-between  w-[90%] lg:w-[80%]  m-auto box__Shadow mt-5">
        {/* Left Side (Image) */}
          ...
          <button
            ...
            className={`${
              product.stock <= quantity
                ...
                : "bg-blue-500 text-white py-2 px-4 rounded-md mr-5"
            }`}
            onClick={addToCart}
          >
            Add to Cart
