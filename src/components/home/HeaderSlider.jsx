...
import img2 from "../../assets/sliderimg1.jpg";
  ...
  return (
    <div>
      <Swiper
        ...
        style={{ width: "", maxHeight: "60%", objectFit: "cover" }}
      >
        {/* <SwiperSlide>
          ...
          <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
            ...
            <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
              <div
                ...
                style={{
                  backgroundImage:
                    'url("https://images.unsplash.com/photo-1544441893-675973e31985?ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80")',
                }}
              >
                <button className="p-2 rounded-full bg-blue-600 text-white mx-5 -mb-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                  <svg
            ...
            <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
              <div
                ...
                style={{
                  backgroundImage:
                    'url("https://images.unsplash.com/photo-1590664863685-a99ef05e9f61?ixlib=rb-1.2.1&auto=format&fit=crop&w=345&q=80")',
                }}
              >
                <button className="p-2 rounded-full bg-blue-600 text-white mx-5 -mb-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                  <svg
